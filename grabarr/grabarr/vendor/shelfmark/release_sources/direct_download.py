...
# Original path: shelfmark/release_sources/direct_download.py. Licensed MIT; see ATTRIBUTION.md.
...
from grabarr.vendor.shelfmark.config.env import DEBUG_SKIP_SOURCES, TMP_DIR
from grabarr.vendor.shelfmark._grabarr_adapter import shelfmark_config_proxy as config
from grabarr.vendor.shelfmark.core.utils import CONTENT_TYPES, get_aa_content_type_dir, is_audiobook as check_audiobook
from grabarr.core.logging import setup_logger
from grabarr.vendor.shelfmark.core.models import SearchFilters, DownloadTask, build_filename
from grabarr.vendor.shelfmark.metadata_providers import BookMetadata, group_languages_by_localized_title
